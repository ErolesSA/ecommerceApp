'use client'
import Cart from './Cart.jsx' // Importa el componente del carrito
...
export default function Navbar() {
    ...
    const [open, setOpen] = useState(false); // Estado para abrir o cerrar el carrito
    const [cartItems, setCartItems] = useState([
        // Aquí defines los productos en el carrito. Si no tienes productos, pon un array vacío.
        { id: 1, name: 'Throwback Hip Bag', price: '$90.00', quantity: 1, imageSrc: 'https://tailwindui.com/...' },
        { id: 2, name: 'Medium Stuff Satchel', price: '$32.00', quantity: 1, imageSrc: 'https://tailwindui.com/...' },
    ]);
                            ...
                            <div className="ml-auto flex items-center">
                                ...
                                <div>
                                    ...
                                    <div className="ml-4 flow-root lg:ml-6">
                                        <a href="#" onClick={() => setOpen(true)} className="group -m-2 flex items-center p-2">
...
{open && (
    <div
        className="fixed inset-0 z-50 transition-transform transform duration-300 ease-in-out translate-x-full opacity-0"
        style={{ transform: open ? 'translateX(0)' : 'translateX(100%)', opacity: open ? 1 : 0 }}
    >
